...
Online documentation & example code available at: https://github.com/devmastery/UnityNativeGallery
...
- set the value of 'Automated Setup' to false at 'Project Settings/devmastery/Native Gallery'
- build your project
...
4. SCRIPTING API
Please see the online documentation for a more in-depth documentation of the Scripting API: https://github.com/devmastery/UnityNativeGallery
